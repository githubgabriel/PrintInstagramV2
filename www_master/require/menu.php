    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-9">
            <ul class="nav navbar-nav">
                ...
                <li class="<?=($mi=="hashtag_listen")?"active":null;?>"><a href="./hashtag_listen.php"> Hashtag Listen <span class="badge">1</span> </a></li>
                <li class="<?=($mi=="hashtag_imagens")?"active":null;?>"> <a href="./hashtag_imagens.php">Hashtag Imagens </a></li>
                <li class="<?=($mi=="impressoras_online")?"active":null;?>"><a href="./impressoras_online.php"> Impressoras Online <span class="badge">2</span></a></li>
                <li class="<?=($mi=="impressoras_requisicoes")?"active":null;?>"> <a href="./impressoras_requisicoes.php">Impressoras Requisições <span class="badge">2</span></a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>
