...
<div class="container">
    ...
    <div class="col-md-6" style="margin-top:10px;">
        ...
        <form class="form-horizontal" id="form1" onsubmit="return updateConfigTerminal()">
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input type="text" name="nome_impressora" value="<?= $_SESSION["IMPRESSORA_NOME"] ?>"
                           class="form-control" placeholder="Impressora01">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input type="text" name="ip_server_master" value="<?= $_SESSION["SERVER_MASTER"] ?>"
                           class="form-control ip_address" placeholder="127.0.0.1">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
    ...
    <div class="col-sm-2">
        <button type="button" id="initServer" class="btn btn-default" onclick="initServer()">Iniciar Server Cliente
        </button>
    </div>
    <div class="col-sm-2">
        <div id="loading_initServer" style="display:none;position:relative;top:5px;"><img
                src="images/icon-refresh.gif"/> Atualizando..
        </div>
    </div>
